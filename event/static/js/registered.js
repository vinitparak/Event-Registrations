		...
		<div class="card">
			<header class="card-header">
                ...
                <div class="card-header-icon">
                    <button class="button is-danger" id="unregister">Unregister</button>
                </div>
			</header>
...
class PostElement extends HTMLElement {
    ...
    connectedCallback() {
        ...
        let postId = this.getAttribute("id");
       	...
       	this.shadowRoot.querySelector("#unregister").addEventListener('click', e => {
       	    let edata;
       	    $.ajax({
       	        async: false,
       	        type: 'GET',
       	        url: '/unregister/'+postId,
    ...
    addPostData(data) {
    	let tags = ['title', 'description', 'no_of_attendees', 'time'];
